...
serverAddressList=["192.168.0.9"]    # Put your Phone IP here, multiple IPs are supported now (untested)!
serverPort=8080
bufferSize=12
nPhotos=200                      # How many photos do you want? (~180 for best quality)

serialConnection = serial.Serial('/dev/ttyUSB0',9600)   # Change this to COMx if you are on Windows, COMx is the port where Arduino serial is connected
